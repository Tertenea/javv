public class h3 {
    public static void main(String[] args) {
        ...
        System.out.println("Esimene element: " + massiiv[0]);

        System.out.println("Viimane element: " + massiiv[massiiv.length - 1]);

        int elementideArv = massiiv.length;
        System.out.println("Elementide arv massiivis: " + elementideArv);

        int summa = 0;
        for (int i = 0; i < elementideArv; i++) {
            summa += massiiv[i];
        }
